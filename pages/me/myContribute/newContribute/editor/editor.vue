		...
		<view class="page-body">
			<view class='wrapper'>
				...
				<editor id="editor" class="ql-container" placeholder="开始输入..." showImgSize showImgToolbar showImgResize
				 @statuschange="onStatusChange" :read-only="readOnly" @ready="onEditorReady" @blur="saveTostore">
				</editor>
			</view>
		</view>
			...
			onEditorReady(e) {
				uni.createSelectorQuery().select('#editor').context((res) => {
					...
					this.editorCtx.setContents({
						delta:this.articleDetail.delta||this.articleDetail
					})
				}).exec()
			},
			undo() {
